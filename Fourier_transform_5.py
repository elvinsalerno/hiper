...
#input_filename="inversion_recovery"


input_directory=r"C:\SpecManData\Krish\tempol\0p25mM"
input_filename="hole_94_40KAvg"

input_directory=r"C:\SpecManData\Krish\Phase_check"
input_filename="100to200MHz_wurstPulseN3"
...
cutoff_ind=[1000,1600]

f_add=94.


times_corr=0#500#400
...
def fourier_func(Col): 
    ...
    ##############To add delay between channels. Set times_corr=0 if none#########################
    #data_re=data_re[:-1]
    #data_im=data_im[1:]
    #times=times[:-1]
