...
input_directory=r'C:\SpecManData\Gd3NC80Cu\11152021'
input_filename='ELDOR_Gd3@c60_10dB_5K_3.390_1.8GHzref_94GHzosc'


#write in terms of ns
corrections=[[450,550],[600,700]]
integ_limit=[200,400]
...
frequency=[93.4,93.45,93.5,93.55,93.6,93.65,93.7,93.75,93.8,93.85,93.9,93.95,94,94.05,94.1,94.15,94.2,94.25,94.3,94.35,94.4,94.45,94.5,94.55,94.6]
value=[1.25,2.87,8.25,17.25,26.9,31.9,28.12,22.60,16.60,51.12,51.12,51.12,13.25,13.90,13.90,17.12,17.50,20.40,20.40,21.10,16.90,14.90,8.10,2.85,1.50]
print(len(frequency),len(value))
...
fig.add_trace(go.Scatter(x=f_add+times_3[start_trace:end_trace], y=integs,
            mode='lines',
            name='xxx'))
fig.update_xaxes(title='sat pulse freq (GHz)')
